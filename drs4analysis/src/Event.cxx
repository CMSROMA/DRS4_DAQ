...
//  tree->Branch("triggerBits",&treeData.triggerBits,"triggerBits/i");
  ...
  tree->Branch("digiSampleValue",treeData.digiSampleValue,"digiSampleValue[nDigiSamples]/s");
  tree->Branch("digiSampleCalibValue",treeData.digiSampleCalibValue,"digiSampleCalibValue[nDigiSamples]/F");
  ...
  for (unsigned int i = 0 ; i < fmin (MAX_DIGI_SAMPLES, digiValues.size ()) ;++i)
    {
      ...
      treeData.digiSampleValue[i] = digiValues[i].sampleRaw;
      treeData.digiSampleTime[i] = digiValues[i].sampleTime ;
      treeData.digiSampleCalibValue[i] = digiValues[i].sampleValue ;
    }
